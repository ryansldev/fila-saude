      ...
      <IllustrationScene>
        <PhoneFrame>
          <div className="space-y-3 px-1 pb-2 pt-1">
            <p className="text-sm font-bold lowercase tracking-wide text-gray-500">pra quem é?</p>
            ...
            <p className="text-sm font-bold lowercase tracking-wide text-gray-500">do que precisa?</p>
